                ...
                <div className={`bg-white rounded-2xl shadow-lg p-6 mb-6 transform transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        {!isEdit && (
                            <button
                                ...
                                className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
                            >
                                📷 Register Face
                            </button>
                        )}
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Phone Number (SMS Alerting)</label>
                                {isEdit ? (
                                    <input
                                        type="text"
                                        value={formData.phone}
                                        onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300 font-mono"
                                        placeholder="+1234567890"
                                    />
                                ) : (
                                    <p className="text-gray-800 font-medium font-mono">{adminData.phone || 'Not Set'}</p>
                                )}
                            </div>
