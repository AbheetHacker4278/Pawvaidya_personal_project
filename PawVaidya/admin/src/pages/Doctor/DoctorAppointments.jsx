            ...
            >
              ...
              <div className="p-5 flex flex-col lg:flex-row gap-5 items-start lg:items-center">
                ...
                <div className="flex flex-col items-start lg:items-center min-w-[80px]">
                  ...
                  <span className={`px-3 py-0.5 rounded-full text-xs font-bold border ${item.payment === true ? 'bg-blue-50 text-blue-700 border-blue-200' : 'bg-orange-50 text-orange-700 border-orange-200'}`}>
