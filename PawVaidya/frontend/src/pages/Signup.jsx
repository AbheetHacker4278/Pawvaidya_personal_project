      ...
      <div className={`w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 bg-[#F2E4C6] transform transition-all duration-1000 delay-200 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'
        ...
        <div className="w-full max-w-md bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/50">
          ...
          <form onSubmit={onSubmitHandler} className="space-y-4 bg-transparent">
            ...
            {/* Social Logins */}
            <div className={`transform transition-all duration-500 delay-1050 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
              <button
                type="button"
                onClick={() => handleSocialClick('google')}
                className="w-full flex items-center justify-center gap-2 py-4 px-4 rounded-xl font-semibold text-sm border border-gray-300 hover:bg-gray-50 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-sm bg-white text-gray-700"
              >
            ...
            <div className={`flex items-center bg-transparent transform transition-all duration-500 delay-1100 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}>
